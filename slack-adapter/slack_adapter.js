...
class SlackAdapter extends botbuilder_1.BotAdapter {
    ...
    constructor(options) {
         ...
         * @ignore
         */
        this.botkit_worker = botworker_1.SlackBotWorker;
                ...
                if (activity.type === botbuilder_1.ActivityTypes.Message) {
                    ...
                    try {
                        ...
                        if (result.ok === true) {
                            ...
                            console.error('Error sending activity to API1:', result);
                        }
                    }
                    catch (err) {
                        console.error('Error sending activity to API2:', err);
                    }
                }
                else {
    ...
    processActivity(req, res, logic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield this.verifySignature(req, res))) {
            }
                ...
                if (this.options.verificationToken && event.token !== this.options.verificationToken) {
                    ...
                    const activity = {
                        ...
                        channelId: 'slack',
                        conversation: {
                            id: event.channel ? event.channel.id : event.api_app_id,
                    ...
                    activity.recipient.id = yield this.getBotUserByTeam(activity);
